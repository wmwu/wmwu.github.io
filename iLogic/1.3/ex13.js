...
function write_questions()
{
	...
	//alert(N);
	document.write("<input type=\"button\" onclick=\"get_radio_value();\" value=\"Check Answers\" style=\"font-size:16px; margin: 10px 0 0 90px; cursor: pointer;\" />");
	window.scrollTo(0,0);
}
...
//			document.write("</label>");
	...
	document.write("<input type=\"button\" onclick=\"get_radio_value();\" value=\"Check Answers\" style=\"font-size:16px; margin-left: 60px; cursor: pointer;\" />");
