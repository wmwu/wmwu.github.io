...
function write_questions()
{
	...
	//alert(N);
	document.write("<input type=\"button\" onclick=\"get_radio_value();\" value=\"Check Answers\" style=\"font:16px 'Noto Sans'; margin: 20px 0 0 90px; border-radius: 3px; border-width: 1px; height: 28px; cursor: default;\" />");
	window.scrollTo(0,0);
}
...
//	alert(X[5]);
	...
	document.write("<input type=\"button\" onclick=\"write_random_questions();\" value=\"Do Ex 1.3 sec I again with a different set of questions\" style=\"font-family: 'Noto Sans', sans-serif; font-size:16px; border-radius: 3px; border-width: 1px; margin-top: 20px; height: 28px; cursor: default;\" />");
	...
	document.write("<input type=\"button\" onclick=\"window.location.replace('iLogic_1_3.html');\" value=\"Return to 1.3\" style=\"font-family: 'Noto Sans', sans-serif; font-size:16px; border-radius: 3px; border-width: 1px; margin-top: 20px; height: 28px; cursor: default;\" />");
