function check_answers()
	...
	document.write("<div style=\"position: absolute; margin: 33px 0 0 31px\"><input type=\"text\" class=\"tv\" name=\"tv1\" id=\"tv1\" value=\"" + v1 + "\" \/><\/div>");
	...
	document.write("<input type=\"button\" onclick=\"window.location.replace('SO_2.html')\" value=\"Redo\" style=\"font-size: 13px; position: absolute; margin: 290px 0 0 110px; cursor: pointer\" \/>");
	document.write("<\/form>");
        if (x1.value == "?")
	  {
		$("#m1c").css({ opacity: .8 });
