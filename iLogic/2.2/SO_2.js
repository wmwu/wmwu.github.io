function check_answers()
	...
	document.write("<script type=\"text\/javascript\" src=\"SO_2.js\"><\/script>");
	...
	document.write("<div class=\"tv\" style=\"position: absolute; margin: 204px 0 0 28px\">T<\/div>");
	...
	document.write("<input type=\"button\" onclick=\"window.location.replace('SO_2.html')\" value=\"Redo\" style=\"font-size: 16px; position: absolute; margin: 290px 0 0 110px; cursor: pointer\" \/>");
	document.write("<\/body>");
	document.write("<\/html>");
   	  if (x1.value == "?")
	  {
