function check_answers()
	...
	document.write("<script type=\"text\/javascript\" src=\"SO_6.js\"><\/script>");
	...
	document.write("<input type=\"button\" onclick=\"window.location.replace('SO_6.html')\" value=\"Redo\" style=\"font-size: 16px; position: absolute; margin: 290px 0 0 110px; cursor: pointer\" \/>");
	document.write("<\/body>");
	document.write("<\/html>");
   	  if (x1.value == "f" || x1.value == "F")
	  {
