function check_answers()
	...
	document.write("<script type=\"text\/javascript\" src=\"SO_9.js\"><\/script>");
	...
	document.write("<input type=\"button\" onclick=\"window.location.replace('SO_9.html')\" value=\"Redo\" style=\"font-size: 16px; position: absolute; margin: 290px 0 0 110px; cursor: pointer\" \/>");
	document.write("<\/body>");
	document.write("<\/html>");
   	  if (x1.value == "?")
	  {
