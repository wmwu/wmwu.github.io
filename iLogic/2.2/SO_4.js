function check_answers()
	...
	document.write("<script type=\"text\/javascript\" src=\"SO_4.js\"><\/script>");
	...
	document.write("<div class=\"tv\" style=\"position: absolute; margin: 36px 0 0 198px\">F<\/div>");
	...
	document.write("<input type=\"button\" onclick=\"window.location.replace('SO_4.html')\" value=\"Redo\" style=\"font-size: 16px; position: absolute; margin: 290px 0 0 110px; cursor: pointer\" \/>");
	document.write("<\/body>");
	document.write("<\/html>");
   	  if (x1.value == "?")
	  {
