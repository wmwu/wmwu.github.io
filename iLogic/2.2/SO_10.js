function check_answers()
	...
	document.write("<script type=\"text\/javascript\" src=\"SO_10.js\"><\/script>");
	...
	document.write("<div style=\"position: absolute; margin: 33px 0 0 30px\"><input type=\"text\" class=\"tv\" name=\"tv1\" id=\"tv1\" value=\"" + v1 + "\" \/><\/div>");
	...
	document.write("<div style=\"position: absolute; margin: 33px 0 0 198px\"><input type=\"text\" class=\"tv\" name=\"tv2\" id=\"tv2\" value=\"" + v2 + "\" \/><\/div>");
	...
	document.write("<div style=\"position: absolute; margin: 204px 0 0 30px\"><input type=\"text\" class=\"tv\" name=\"tv3\" id=\"tv3\" value=\"" + v3 + "\" \/><\/div>");
	...
	document.write("<div class=\"tv\" style=\"position: absolute; margin: 204px 0 0 198px\">T<\/div>");
	document.write("<div class=\"mark\" id=\"m1c\" style=\"position: absolute; margin: 29px 0 0 22px\"><img src=\"mc.png\"><\/div>");
	document.write("<div class=\"mark\" id=\"m1e\" style=\"position: absolute; margin: 29px 0 0 22px\"><img src=\"me.png\"><\/div>");
	document.write("<div class=\"mark\" id=\"m2c\" style=\"position: absolute; margin: 29px 0 0 190px\"><img src=\"mc.png\"><\/div>");
	document.write("<div class=\"mark\" id=\"m2e\" style=\"position: absolute; margin: 29px 0 0 190px\"><img src=\"me.png\"><\/div>");
	document.write("<div class=\"mark\" id=\"m3c\" style=\"position: absolute; margin: 200px 0 0 22px\"><img src=\"mc.png\"><\/div>");
	document.write("<div class=\"mark\" id=\"m3e\" style=\"position: absolute; margin: 200px 0 0 22px\"><img src=\"me.png\"><\/div>");
	document.write("<input type=\"button\" onclick=\"window.location.replace('SO_10.html')\" value=\"Redo\" style=\"font-size: 16px; position: absolute; margin: 290px 0 0 110px; cursor: pointer\" \/>");
	document.write("<\/body>");
	document.write("<\/html>");
   	  if (x1.value == "t" || x1.value == "T")
	  {
