...
function write_questions()
{
	...
	//alert(N);
	document.write("<input type=\"button\" onclick=\"get_radio_value();\" value=\"Check Answers\" style=\"font: 16px 'Noto Sans', sans-serif; margin: 20px 0 0 80px; cursor: default;\" />");
	window.scrollTo(0,0);
}
...
function write_random_questions()
{
	...
	document.write("<input type=\"button\" onclick=\"get_radio_value();\" value=\"Check Answers\" style=\"font: 16px 'Noto Sans', sans-serif; margin: 20px 0 0 100px; cursor: default;\" \/>");
...
//	alert(X[5]);
	...
	document.write("<input type=\"button\" onclick=\"write_random_questions();\" value=\"Do the exercise again with a different set of questions\" style=\"font: 16px 'Noto Sans', sans-serif; cursor: default;\" \/>");
	...
	document.write("<input type=\"button\" onclick=\"window.location.replace('iLogic_1.html')\" value=\"Return to 1.1\" style=\"font: 16px 'Noto Sans', sans-serif; cursor: default;\" \/>");
